...
create_files_response = httpx.post("http://localhost:8000/api/v1/files",
    data={"filename": "image.png", "directory": "courses"},
    files={"upload_file": open ('./testdata/files/Губка_Боб_персонаж.png','rb')},
    headers=create_file_header

)

create_file_response_data = create_files_response.json()
print(create_file_header)
